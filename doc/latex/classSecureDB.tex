...
\index{Secure\+DB@{Secure\+DB}!Apply\+M\+Token@{Apply\+M\+Token}}
\index{Apply\+M\+Token@{Apply\+M\+Token}!Secure\+DB@{Secure\+DB}}
\subsubsection[{\texorpdfstring{Apply\+M\+Token(string, string, string)}{ApplyMToken(string, string, string)}}]{\setlength{\rightskip}{0pt plus 5cm}vector$<$ string $>$ Secure\+D\+B\+::\+Apply\+M\+Token (
\begin{DoxyParamCaption}
\item[{string}]{query\+\_\+name, }
\item[{string}]{db\+\_\+name, }
\item[{string}]{res\+\_\+name}
\end{DoxyParamCaption}
)}\hypertarget{classSecureDB_a701ae7b9972bea6b4349ff35003a7a34}{}\label{classSecureDB_a701ae7b9972bea6b4349ff35003a7a34}
Get a token file name (query\+\_\+name), the database name (db\+\_\+name) and the results name (res\+\_\+name).

Execute the mtoken for all the rows in res\+\_\+name and return all the founded results in a vector. \index{Secure\+DB@{Secure\+DB}!Apply\+P\+Token@{Apply\+P\+Token}}
\index{Apply\+P\+Token@{Apply\+P\+Token}!Secure\+DB@{Secure\+DB}}
\subsubsection[{\texorpdfstring{Apply\+P\+Token(string, string, string)}{ApplyPToken(string, string, string)}}]{\setlength{\rightskip}{0pt plus 5cm}int Secure\+D\+B\+::\+Apply\+P\+Token (
\begin{DoxyParamCaption}
\item[{string}]{query\+\_\+name, }
\item[{string}]{db\+\_\+name, }
\item[{string}]{res\+\_\+name}
\end{DoxyParamCaption}
)}\hypertarget{classSecureDB_a24b57c65385caf873e389f1180d374e3}{}\label{classSecureDB_a24b57c65385caf873e389f1180d374e3}
Get a token file name (query\+\_\+name), the database name (db\+\_\+name) and the results name (res\+\_\+name).

Execute the ptoken for the desiderd database and save the number of all the founded rows in a file (res\+\_\+name). \index{Secure\+DB@{Secure\+DB}!Apply\+Token@{Apply\+Token}}
